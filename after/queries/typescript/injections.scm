...
; query
;; tagged template sql injection with generics (sql<Type>`...`)
((binary_expression
  right: (template_string
    (string_fragment) @injection.content))
  (#match? @injection.content "SELECT|INSERT|UPDATE|DELETE|WITH|CREATE|ALTER|DROP")
  (#set! injection.language "sql"))

; query
;; tagged template sql injection
((call_expression
